...
<%@ page import="com.digitalGovernace.entity.Complaint" %> <!-- Replace with your actual package -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
 <div class="header">
        <h1>Admin</h1>
        <form action="http://localhost:8090/home" method="GET">
        ...
        <table>
            ...
            <tbody>
                <%
                    List<Complaint> complaints = (List<Complaint>) request.getAttribute("studentComplaints");
                ...
                %>
                    <tr>
                        ...
                        <td><%= complaint.getContactNumber() %></td>
                        <td>
                            <form action="/deleteComplaints" method="post">
                                <input type="hidden" name="id" value="<%= complaint.getId() %>" />
                                 <input type="hidden" name="email" value="<%= complaint.getEmail() %>" />
